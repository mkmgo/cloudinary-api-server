...
app.get('/list-table/:account', async (req, res) => {
    try {
        ...
        <head>
            ...
            <title>Media Library — ${req.params.account}</title>
        ...
        <body>
            <div class="container">
                <div class="header">
                    ...
                    <h1>Media Library</h1>
                    <span class="badge">${req.params.account}</span>
                </div>
                        ...
                        <tbody>
                            ...
                            filtered.map(asset => {
                                ...
                                return '<tr>' +
                                    ...
                                    '<td class="copy-cell"><button class="copy-btn" onclick="copyUrl(this,\'' + asset.secure_url.replace(/'/g, "\\'") + '\')" title="Copy URL">' +
